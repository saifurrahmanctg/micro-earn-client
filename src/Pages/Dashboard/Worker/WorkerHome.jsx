...
const WorkerHome = () => {
    ...
    return (
        <div className="fade-in">
            <h2 className="text-3xl font-bold text-[#333333] dark:text-white mb-8">Welcome, <span className="text-[#2bb673]">{user?.displayName}</span></h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
                <div className="bg-white dark:bg-gray-800 p-8 rounded-xl border border-gray-100 dark:border-gray-700 shadow-sm flex items-center gap-6 transition-colors duration-300">
                    <div className="w-16 h-16 bg-blue-50 dark:bg-blue-900/20 text-blue-500 rounded-full flex items-center justify-center text-3xl">
                        <FaTasks />
                    </div>
                    <div>
                        <p className="text-gray-400 font-bold uppercase tracking-widest text-[10px] mb-1">Total Submissions</p>
                        <h3 className="text-3xl font-black text-[#333333] dark:text-white">{stats?.totalSubmissions || 0}</h3>
                    </div>
                </div>

                <div className="bg-white dark:bg-gray-800 p-8 rounded-xl border border-gray-100 dark:border-gray-700 shadow-sm flex items-center gap-6 transition-colors duration-300">
                    <div className="w-16 h-16 bg-orange-50 dark:bg-orange-900/20 text-orange-500 rounded-full flex items-center justify-center text-3xl">
                        <FaHourglassHalf />
                    </div>
                    <div>
                        <p className="text-gray-400 font-bold uppercase tracking-widest text-[10px] mb-1">Pending Submissions</p>
                        <h3 className="text-3xl font-black text-[#333333] dark:text-white">{stats?.pendingSubmissions || 0}</h3>
                    </div>
                </div>

                <div className="bg-white dark:bg-gray-800 p-8 rounded-xl border border-gray-100 dark:border-gray-700 shadow-sm flex items-center gap-6 transition-colors duration-300">
                    <div className="w-16 h-16 bg-green-50 dark:bg-green-900/20 text-[#2bb673] rounded-full flex items-center justify-center text-3xl">
                        <FaDollarSign />
                    </div>
                    <div>
                        <p className="text-gray-400 font-bold uppercase tracking-widest text-[10px] mb-1">Total Earnings</p>
                        <h3 className="text-3xl font-black text-[#333333] dark:text-white">{stats?.totalEarnings || 0}</h3>
                    </div>
                </div>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-100 dark:border-gray-700 shadow-sm overflow-hidden transition-colors duration-300">
                <div className="p-6 border-b border-gray-100 dark:border-gray-700 flex justify-between items-center">
                    <h3 className="font-bold text-[#333333] dark:text-white">Recent Submissions</h3>
                </div>
                <div className="overflow-x-auto">
                    <table className="table w-full">
                        <thead>
                            <tr className="bg-gray-50 dark:bg-gray-700 text-gray-400 uppercase text-[10px] tracking-widest">
                        ...
                        <tbody>
                            {submissions.length === 0 ? (
                                ...
                                submissions.map((sub) => (
                                    <tr key={sub._id} className="hover:bg-gray-50 dark:hover:bg-gray-700 border-b border-gray-50 dark:border-gray-700 last:border-0 transition-colors">
                                        <td className="font-bold text-[#333333] dark:text-white">{sub.task_title}</td>
                                        <td className="font-bold text-[#2bb673]">{sub.payable_amount} Coins</td>
                                        <td className="text-gray-500 dark:text-gray-400 font-medium">{sub.buyer_name}</td>
                                        <td>

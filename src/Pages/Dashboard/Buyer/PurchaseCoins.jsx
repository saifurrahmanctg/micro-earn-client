    ...
    return (
        <div className="fade-in">
            <div className="mb-12 text-center">
                <h2 className="text-4xl font-black text-[#333333] mb-3">Refill Your <span className="text-[#2bb673]">Dashboard</span></h2>
                <p className="text-gray-500 font-medium text-lg">Choose a package to post more tasks and grow your community</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                {coinPackages.map((pkg, index) => (
                    <div 
                        key={index}
                        className={`bg-white rounded-2xl border ${pkg.popular ? 'border-[#2bb673] ring-4 ring-green-50 scale-105' : 'border-gray-100'} p-8 shadow-premium relative flex flex-col items-center text-center transition-all hover:-translate-y-2`}
                    >
                        {pkg.popular && (
                        ...
                        <div className={`w-16 h-16 rounded-2xl ${pkg.popular ? 'bg-[#2bb673] text-white shadow-lg shadow-green-200' : 'bg-gray-50 text-[#2bb673]'} flex items-center justify-center text-2xl mb-6`}>
                            <FaGem />
                        </div>

                        <h3 className="text-sm font-black text-gray-400 uppercase tracking-widest mb-2">{pkg.label}</h3>
                        <div className="flex items-baseline gap-1 mb-8">
                            <span className="text-4xl font-black text-[#333333]">{pkg.coins}</span>
            ...
            <div className="mt-16 bg-white p-10 rounded-2xl border border-gray-100 shadow-premium flex flex-col md:flex-row items-center justify-between gap-8">
                <div className="flex items-center gap-6">
                    <div className="w-16 h-16 rounded-full bg-green-50 flex items-center justify-center text-[#2bb673] text-2xl">
                        <FaGem />
                    </div>
                    <div>
                        <h4 className="text-xl font-bold text-[#333333]">Need a Custom Package?</h4>
                        <p className="text-gray-500 font-medium">Contact our enterprise sales for bulk coin purchases and API access.</p>
                    </div>
                </div>

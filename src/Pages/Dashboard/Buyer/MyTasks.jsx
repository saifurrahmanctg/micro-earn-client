    ...
    return (
        <div className="fade-in">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-10">
                <div>
                    <h2 className="text-3xl font-bold text-[#333333]">My <span className="text-[#2bb673]">Tasks</span></h2>
                    <p className="text-gray-500 font-medium">Manage and monitor your active job postings</p>
                </div>
                <div className="flex items-center gap-3 bg-white px-4 py-2 rounded-lg border border-gray-100 text-sm font-bold text-gray-500">
                ...
                <div className="overflow-x-auto">
                    <table className="table w-full border-collapse">
                        ...
                        <tbody className="divide-y divide-gray-50">
                            {tasks.map((task) => (
                                <tr key={task._id} className="hover:bg-green-50/30 transition-colors group">
                                    <td className="py-5 px-8">
                                        <div className="flex items-center gap-4">
                                            ...
                                            <span className="font-bold text-[#333333] group-hover:text-[#2bb673] transition-colors">{task.task_title}</span>
                                        </div>
                                    </td>
                                    <td className="font-bold text-gray-600">
                                        <span className="bg-gray-100 px-3 py-1 rounded-full text-xs">{task.required_workers} workers</span>
                                    </td>
                                    <td className="font-black text-[#333333]">
